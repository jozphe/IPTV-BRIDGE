...
exports.titleIdentity = titleIdentity;
...
function titleIdentity(rawTitle) {
...
function cleanTitle(rawTitle) {
    ...
    // Extract Quality
    let quality;
    if (/4K|UHD|2160p/i.test(title))
        quality = '4K UHD';
    else if (/1080p|FHD/i.test(title))
        quality = '1080p';
    else if (/720p|HD/i.test(title))
        quality = '720p';
    else if (/SD|480p/i.test(title))
        quality = 'SD';
    // Clean title text
    let cleaned = title;
